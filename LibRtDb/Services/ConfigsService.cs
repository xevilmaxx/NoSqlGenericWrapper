...
namespace LibRtDb.Services
{
    public class ConfigsService
    {
        ...
        private void GenericKeyUpsert(IGenericNoSqlLightweightSession session, long DeviceId, string Key, dynamic Value)
        {
        ...
        private void StaticKeyUpsert(IGenericNoSqlLightweightSession session, long DeviceId, string Key, dynamic Value)
        {
        ...
        private void GlobalGenericKeyUpsertLogic(IGenericNoSqlLightweightSession session, long DeviceId, string Key, dynamic Value, bool? IsDynamicKey = null)
        {
